...
//блок 1
 ...
 CURLOPT_URL =>
'http://nginxserver/api/'.$_POST['query'],
 ...
 <label for="query_operand">query operand </label>
 <input type="string" name="query" id="query" required>
...
- 1)];
 ...
 $image_path = "./images/".generateRandomString().".jpg";//путь ккартинке относительный
